...
<div id="main-content">
        ...
        <div class="content-box-content">
            <div class="tab-content default-tab" id="tab1">
                ...
                <div class="notification attention png_bg">
                    ...
                    <div>This is a Content Box. You can put whatever you want in
                        it. By the way, you can close this notification with the
                        top-right cross.</div>
                </div>
                <table>
                    <thead>
        ...
        <div class="content-box-content">
            <div class="tab-content default-tab">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    in porta lectus. Maecenas dignissim enim quis ipsum mattis
    ...
    <div id="footer">
        ...
        </small> <a href="http://www.mycodes.net/" target="_blank">www.mycodes.net</a>
    </div>
    <!-- End #footer -->
</div>
<!-- End #main-content -->
